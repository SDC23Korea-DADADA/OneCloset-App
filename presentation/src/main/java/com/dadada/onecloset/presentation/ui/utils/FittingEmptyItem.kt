...
sealed class FittingEmptyItem(val icon: Int, val content: String) {
    object EmptyTop: FittingEmptyItem(R.drawable.ic_t_shirt, "상의를 등록하세요.")
    object EmptyBottom: FittingEmptyItem(R.drawable.ic_jeans, "하의를 등록하세요.")
    object EmptyOne: FittingEmptyItem(R.drawable.ic_dress, "한벌옷을 등록하세요.")
